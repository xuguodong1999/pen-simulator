...
const env = generateMsvcEnv({
    ...
    msvcDir: path.resolve('C:/Program Files/Microsoft Visual Studio/2022/Community/VC/Tools/MSVC/14.38.33130'),
});

const QT_ROOT = path.resolve('C:/Shared/Qt/6.5.3/msvc2022_64_static_mt');
...
const config: ICMakeBuildConfig = {
    ...
    config: {
        ...
        options: [
            ...
            'PYTHON_EXECUTABLE=C:/Users/xgd/.conda/envs/nn/python.exe',
        ]
    },
    build: {
        parallel: true,
