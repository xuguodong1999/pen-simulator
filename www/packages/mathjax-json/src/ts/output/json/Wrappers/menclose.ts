...
import {CommonMencloseMixin} from 'mathjax-full/js/output/common/Wrappers/menclose';
import {JSONmsqrt} from './msqrt';
import * as Notation from '../Notation';
import {MmlMenclose} from 'mathjax-full/js/core/MmlTree/MmlNodes/menclose';
import {OptionList} from 'mathjax-full/js/util/Options';

/*****************************************************************/
/**
 * The JSONmenclose wrapper for the MmlMenclose object
 *
 ...
 */
// @ts-ignore
export class JSONmenclose<N, T, D> extends CommonMencloseMixin<
    JSONWrapper<any, any, any>,
    JSONmsqrt<any, any, any>,
    any,
    JSONConstructor<any, any, any>
>(JSONWrapper) {
     ...
     */
    public static notations: Notation.DefList<JSONmenclose<any, any, any>, any> = new Map([
    ...
    ] as Notation.DefPair<JSONmenclose<any, any, any>, any>[]);
    ...
    public toJSON(parent: N) {
        ...
        if (this.renderChild) {
            ...
            this.childNodes[0].toJSON(block);
        }
        //
    ...
    /**
     * Create an arrow using JSON elements
     *
